...
///////////////////////////////////////////////////////////// // Practice 6 დაწერეთ კონსოლ აპლიკაცია, რომელიც მომხმარებელს მოსთხოვს შეიტანოს ორგანზომილებიანი მასივის ზომები და შექმნის ამ ზომების მასივს, ასევე მომხმარებელმა უნდა შეძლოს მასივის ყველა ელემენტის შეტანა და პროგრამამ უნდა გადაავსოს მასივი შემოტანილი ინფორმაციით. საბოლოოს დაბეჭდოს მისი ყველა ელემენტი მატრიცის სახით
